      ...
      for (const payment of payments) {
        try {
          await Payment.create({
            ...
            status: (payment.status as 'created' | 'captured' | 'failed' | 'refunded') || 'created',
            payment_method: payment.payment_method as string,
            gateway_payment_id: (payment.gateway_payment_id as string) || undefined,
            signature: (payment.signature as string) || undefined,
